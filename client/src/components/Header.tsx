          ...
          <div className="flex items-center space-x-3">
            <img 
              ...
              onError={(e) => {
                ...
                target.parentElement!.innerHTML = '<div class="w-10 h-10 gradient-primary rounded-lg flex items-center justify-center"><span class="text-white font-bold text-sm">F</span></div>';
              }}
            />
            <div className="flex flex-col">
              <span className="text-2xl font-bold bg-gradient-to-r from-[#1fb5d6] to-[#a855f7] bg-clip-text text-transparent tracking-tight">
                FinPlanner
              </span>
